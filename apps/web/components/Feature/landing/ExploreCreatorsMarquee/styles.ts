...
export const Section = styled.section`
  width: 100%;
  background: ${({ theme }) => theme.colors.primary.GRAY || "#f9f9f9"};
...
export const Subtitle = styled.p`
  ...
  max-width: 600px;
  text-align: center;
  color: ${({ theme }) => theme.colors.primary.BLACK_90 || "#333"};
`;
...
export const FilterPill = styled.button<{ $active: boolean }>`
  ...
  border: 1px solid
    ${({ $active, theme }) =>
      $active
        ...
        : theme.colors.neutral.GRAY_300 || "#ddd"};
  border-radius: 999px;
  ...
  &:hover {
    background: ${({ $active, theme }) =>
      $active
        ? theme.colors.neutral.BLACK
        : theme.colors.neutral.GRAY_100 || "#f3f3f3"};
...
export const BrowseAllButton = styled(GenericButton).attrs({
  ...
  &:hover {
    background: ${({ theme }) => theme.colors.neutral.GRAY_700 || "#222"};
    opacity: 0.9;
  }
`;
