  ...
  return (
    <Section>
      <Backdrop>
        {desktopCards.map((card, index) => (
          <Card
            ...
            $height={card.height}
          >
            <CardImage src={card.src} alt="creator" />
            <CardTint />
          </Card>
        ))}
      </Backdrop>
      ...
      <Content>
        ...
        <Subtitle>
          Share your work, build your audience, and earn directly from your
          content. Kiibee helps you publish, promote, and sell in one simple
          platform.
        </Subtitle>
        <CTAButton type="button">Start creating</CTAButton>
      </Content>
    </Section>
  );
}
