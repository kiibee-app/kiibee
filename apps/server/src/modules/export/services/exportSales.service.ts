...
import { users, orders, mediaFiles, collections } from 'src/database/schema';
...
export const exportSalesService = async (
  creatorId: string,
  startDate?: string,
  endDate?: string,
) => {
  try {
    ...
    logger.error('Error generating sales export:', error);
