...
export const buildTopContentRowsHtml = (topContent: TopContentRow[]) => {
  ...
  return `<tr>
                  <td colspan="3" style="padding: 28px 20px; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
                    <p style="margin: 0 0 6px; font-size: 15px; font-weight: 600; color: #444444;">Ingen aktivitet endnu</p>
                    <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #888888;">Ingen indholdsaktivitet blev registreret i denne periode. Del din kanal for at begynde at samle visninger.</p>
                  </td>
                </tr>`;
};
